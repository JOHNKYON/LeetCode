import questions.leetcode849.MaximizeDistancetoClosestPerson;

public class Main {
    public static void main(String[] args) {

        MaximizeDistancetoClosestPerson method= new MaximizeDistancetoClosestPerson();
...
//        System.out.print(method.areSentencesSimilarTwo(words1, words2, pairs));
        System.out.print(method.maxDistToClosest(input));
    }
}
